...
const HomeSlider = () => {
  ...
  const duration = "1";
  const imageUrl = `${basecatagories}slider/${encodeURIComponent(bannerData[0]?.image)}`;
  const imageUrl2 = `${basecatagories}slider/${encodeURIComponent(bannerData[0]?.image2)}`;
  const imageUrl3 = `${basecatagories}slider/${encodeURIComponent(bannerData[0]?.image3)}`;
  return (
      ...
      >
        <div className="swiper-wrapper">
          <SwiperSlide className="swiper-slide">
            <div className="hero-1 bg-cover" style={{backgroundImage: 'url("assets/img/hero/hero-bg.jpg")',}}>
              <div
                ...
                data-delay="2.1s"
              >
                <img src="assets/img/hero/new-chilli-shape.png" alt="shape-img" />
              </div>
              <div
                ...
                data-delay="2.4s"
              >
                <img src="assets/img/hero/new-fire-shape.png" alt="shape-img" />
              </div>
              <div
                ...
                data-delay="2.7s"
              >
                <img src="assets/img/hero/new-chilli-shape-2.png" alt="shape-img" />
              </div>
              <div
                ...
                data-delay="3s"
              >
                <img src="assets/img/hero/new-chilli-shape-3.png" alt="shape-img" />
              </div>
              <div
                ...
                <div className="row justify-content-between">
                  ...
                  <div className="col-xl-6 col-lg-5 mt-5 mt-lg-0">
                    <div
                      ...
                      data-delay="1.4s"
                    >
                      <img src={imageUrl2} alt="chiken-img" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="row justify-content-between">
                  ...
                  <div className="col-xl-6 col-lg-5 mt-5 mt-lg-0">
                    <div
                      ...
                      data-delay="1.4s"
                    >
                      <img src={imageUrl} alt="chiken-img" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="row justify-content-between">
                  ...
                  <div className="col-xl-6 col-lg-5 mt-5 mt-lg-0">
                    <div
                      ...
                      data-delay="1.4s"
                    >
                      <img src={imageUrl3} alt="chiken-img" />
                    </div>
                  </div>
                </div>
              </div>
