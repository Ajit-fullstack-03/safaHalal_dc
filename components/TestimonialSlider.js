                ...
                <SwiperSlide className="swiper-slide">
                  <div className="client-image-item">
                    <div
                      ...
                      style={{
                        backgroundImage: 'url("assets/img/client/client1.jpg")',
                      }}
                    />
                  </div>
                </SwiperSlide>
                <SwiperSlide className="swiper-slide">
                  <div className="client-image-item">
                    <div
                      className="client-img bg-cover"
                      style={{
                        backgroundImage: 'url("assets/img/client/client2.jpg")',
                      }}
                    />
                  </div>
                </SwiperSlide>
                <SwiperSlide className="swiper-slide">
                  <div className="client-image-item">
                    <div
                      className="client-img bg-cover"
                      style={{
                        backgroundImage: 'url("assets/img/client/client3.jpg")',
                      }}
                    />
                  </div>
                </SwiperSlide>
                <SwiperSlide className="swiper-slide">
                  <div className="client-image-item">
                    <div
                      className="client-img bg-cover"
                      style={{
                        backgroundImage: 'url("assets/img/client/client4.jpg")',
                      }}
                    />
                  </div>
                </SwiperSlide>
